...
export default function Projects() {
    return (
        <section className="bg-zinc-300 dark:bg-black flex flex-col text-center 2xl:text-start">
            <UpperDivider />
            <h2 className="self-center text-6xl font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-zinc-950 dark:from-amber-700 via-zinc-600 dark:via-amber-500 to-zinc-950 dark:to-amber-700 p-2 mt-5 mb-[-30px]">Projects</h2>
