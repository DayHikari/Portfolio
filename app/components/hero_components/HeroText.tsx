...
export default function HeroText() {
  return (
    <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex flex-col items-center text-center z-10 bg-gradient-to-br from-zinc-950 dark:from-orange-700 via-zinc-600 dark:via-amber-500 to-zinc-950 dark:to-orange-700 bg-clip-text text-orange-600 dark:text-orange-500 sm:text-transparent sm:dark:text-transparent">
