  ...
  return (
    <main className="bg-zinc-300 dark:bg-black">
      ...
      <section className="flex flex-col py-10">
        <h1 className="p-2 self-center mb-[-30px] text-7xl text-center font-extrabold bg-gradient-radial from-orange-400 to-orange-700 text-transparent bg-clip-text">
          Personal Projects
        </h1>
